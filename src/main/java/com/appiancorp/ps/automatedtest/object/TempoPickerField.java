...
public class TempoPickerField extends TempoField {
    ...
    protected static final String XPATH_RELATIVE_SELECTION = ".//a[@title]";
    protected static final String XPATH_RELATIVE_SPECIFIC_SELECTION = "/descendant::a[contains(text(), '%s')]";
    ...
    public static String getValue(WebElement fieldLayout) {
        ...
        for (WebElement a : fieldLayout.findElements(By.xpath(XPATH_RELATIVE_SELECTION))) {
    ...
    public static boolean contains(WebElement fieldLayout, String fieldValue) {
        try {
            fieldLayout.findElement(By.xpath(String.format(XPATH_RELATIVE_SPECIFIC_SELECTION, fieldValue)));
    ...
    protected static boolean waitForSelection(WebElement fieldLayout, String fieldValue) {
        try {
            ...
            (new WebDriverWait(driver, timeoutSeconds)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(" + xpathLocator + ")" + String.format(XPATH_RELATIVE_SPECIFIC_SELECTION, fieldValue))));
        } catch (TimeoutException e) {
            return false;
        }
