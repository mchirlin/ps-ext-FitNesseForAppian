...
public class Login {
    ...
    public static boolean login(WebDriver driver, int timeOutSeconds, String url, String userName, String password) {
    ...
    public static boolean waitForLogin(WebDriver driver, int timeOutSeconds, String url) {
        driver.get(url);
