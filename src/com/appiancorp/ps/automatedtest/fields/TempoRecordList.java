...
public class TempoRecordList {

    public static boolean click(WebDriver driver, int timeOutSeconds, String listName) {
    ...
    public static boolean waitFor(WebDriver driver, int timeOutSeconds, String listName) {
        try {
    ...
    public static boolean clickOnFacetOption(WebDriver driver, int timeOutSeconds, String facetName) {
    ...
    public static boolean waitForFacetOption(WebDriver driver, int timeOutSeconds, String facetName) {
        try {
