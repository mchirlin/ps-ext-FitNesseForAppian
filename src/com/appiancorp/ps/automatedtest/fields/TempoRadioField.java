...
public class TempoRadioField extends TempoField {
    ...
    public static boolean contains(WebElement fieldLayout, String fieldValue) {
        ...
        // For editable
        WebElement textField = fieldLayout.findElement(By.xpath(".//label[contains(text(), '"+fieldValue+"')]/preceding-sibling::input"));
        
        LOG.debug("Checked value: " + textField.getAttribute("checked"));
        
        return textField.getAttribute("checked").equals("true");
    }
}
